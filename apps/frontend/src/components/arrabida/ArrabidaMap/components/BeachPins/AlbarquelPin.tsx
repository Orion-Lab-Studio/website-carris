...
export function AlbarquelPin({ isActive, zoom = 12 }: BeachPinProps) {
	//
	...
	return (
		...
		>
			...
			<g>
				<path
					d="M975.28,401.87c-8.35-8.35-19.67-13.04-31.48-13.04s-23.13,4.69-31.48,13.04"
					fill="none"
					stroke="#53b069"
					strokeLinecap="round"
					strokeWidth="3"
				/>
				<path
					d="M977.94,325.03c-8.18-4.72-17.9-6-27.02-3.56-9.12,2.44-16.9,8.41-21.62,16.59l61.68,35.61c4.72-8.18,6-17.9,3.56-27.02-2.44-9.12-8.41-16.9-16.59-21.62Z"
					fill="none"
					stroke="#53b069"
					strokeLinecap="round"
					strokeWidth="3"
