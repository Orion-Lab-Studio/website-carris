...
import { FormType } from '@/components/update-portal/UpdatePortalSchoolDetail/types';
import { Button, Paper, PasswordInput, Text, Title } from '@mantine/core';
import { type UseFormReturnType } from '@mantine/form';
import { notifications } from '@mantine/notifications';
import { Dispatch, SetStateAction } from 'react';

import { isPasswordCorrect } from '../UpdatePortalSchoolDetail/SubmitAction';
...
export function SubmitCodeSection({ form, setFormOpen }: Props) {
	//
