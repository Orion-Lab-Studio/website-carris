...
export const allCardsData: Review2024CardSchema[] = [
...

	{
		...
		content: {
			description: 'Este ano, seriam precisas 41 pontes vasco da gama e 213 pontes 25 de abril para caberem todos estes passageiros ao mesmo tempo!',
